...
!(function (t, e) {
  ...
  function qn(t) {
    return (
      Xn() && "string" == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
  ...
  class Zn {
    constructor(t, e) {
      ...
      (this.id = j()),
        ...
        (Kn[n.id] = n),
        l && c
          ? (a.listen(n, "complete", Yn), a.listen(n, "progress", Un), n._initialize(), n.attached && n.update())
    ...
    _initializePlatform(t, e) {
      return e.platform
        ? new e.platform()
        : !Xn() || ("undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas)
          ? new Ze()
          : new hi();
    }
    clear() {
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (
          ...
          Object.assign(i.prototype, { dataElementType: Cn.getElement(r), datasetElementType: o && Cn.getElement(o) }),
    ...
    render() {
      ...
      !1 !== t.notifyPlugins("beforeRender", { cancelable: !0 }) &&
        (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), Yn({ chart: t })));
    }
    draw() {
      const t = this;
      let e;
  ...
  function so(t, e, i, n) {
    ...
    let c, h, d, u;
    for (c = i, h = i + n; c < h; ++c)
      (u = e[c]), (d = {}), (d[o.axis] = r || o.parse(a[c], c)), l.push(oo(u, d, s, c));
    return l;
  }
  function ao(t) {
  ...
  class ro extends Ti {
    ...
    parseObjectData(t, e, i, n) {
      ...
      let d, u, f, g;
      for (d = i, u = i + n; d < u; ++d)
        (g = e[d]), (f = {}), (f[o.axis] = o.parse(lt(g, l), d)), h.push(oo(lt(g, c), f, s, d));
      return h;
    }
    updateRangeFromParsed(t, e, i, n) {
  ...
  (ho.id = "line"),
    (ho.defaults = { datasetElementType: "line", dataElementType: "point", showLine: !0, spanGaps: !1 }),
    ...
    Oo && 1 === e.segments.length
      ...
      : (function (t, e, i, n) {
          const { segments: o, options: s } = e,
            a = Co(e);
          for (const r of o)
            Mo(t, s, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + n - 1 }) && t.closePath(), t.stroke();
        })(t, e, i, n);
  }
  class To extends Ri {
    constructor(t) {
    ...
    draw(t, e, i, n) {
      ...
      (o.points || []).length &&
        s.borderWidth &&
        (t.save(), Ao(t, o, i, n), t.restore(), o.animated && ((o._pointsUpdated = !1), (o._path = void 0)));
    }
  }
  function Ro(t, e, i, n) {
    const o = t.options,
  ...
  function Io(t) {
    ...
    const i = {};
    return e
      ? ((e = t.horizontal ? Fo(e, "left", "right", t.base > t.x) : Fo(e, "bottom", "top", t.base < t.y)),
        (i[e] = !0),
        i)
      : i;
  }
  ...
  (Ho.id = "bar"),
    (Ho.defaults = { borderSkipped: "start", borderWidth: 0, borderRadius: 0, pointStyle: void 0 }),
      ...
      ? (function (t) {
          ...
          if (((h = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue()), n.grid.circular))
            return (
              ...
              new qo({ x: c.x, y: c.y, radius: e.getDistanceFromCenterForValue(h) })
            );
