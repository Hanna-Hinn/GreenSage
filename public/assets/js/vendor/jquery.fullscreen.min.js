...
(function (global, factory) {
  ...
  function native(a, b) {
    ...
    for (var d = 0; d < SUBST.length; ++d) {
      ...
      for (var e = 0; e < VENDOR_PREFIXES.length; ++e)
        if (((c = VENDOR_PREFIXES[e]), (c += 0 === e ? b : b.charAt(0).toUpperCase() + b.substr(1)), defined(a[c])))
          return a[c];
    }
  }
  var SUBST = [
  ...
  FullScreenAbstract.prototype = {
    ...
    _fullScreenError: function (a) {
      this.__options &&
        (this._revertStyles(), (this._fullScreenElement = null), a && $(document).trigger("fscreenerror", [a]));
    },
  ...
  var FullScreenNative = function () {
    FullScreenNative._super.constructor.apply(this, arguments),
      ...
      (this._DEFAULT_OPTIONS = $.extend(!0, {}, this._DEFAULT_OPTIONS, { styles: { width: "100%", height: "100%" } })),
      $(document)
  ...
  var FullScreenFallback = function () {
    FullScreenFallback._super.constructor.apply(this, arguments),
      (this._DEFAULT_OPTIONS = $.extend({}, this._DEFAULT_OPTIONS, {
        styles: { position: "fixed", zIndex: "2147483647", left: 0, top: 0, bottom: 0, right: 0 },
      })),
