  ...
  var m = "day",
    ...
    y = {
      ...
      getDifferenceWithTimezone: function (e, t, i) {
        ...
        return (
          "local" !== i.timeZone &&
            (o = 1e3 * (parseFloat(i.timeZone) * y.getPeriodUnit(a) - -e.getTimezoneOffset() * y.getPeriodUnit(s))),
          i.ignoreTransferTime &&
            (r = 1e3 * (-e.getTimezoneOffset() * y.getPeriodUnit(s) - -t.getTimezoneOffset() * y.getPeriodUnit(s))),
          n - (o + r)
        );
      },
