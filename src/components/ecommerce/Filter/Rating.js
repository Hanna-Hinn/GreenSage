                ...
                <>
                  <div className="product-rate-cover">
                    <div className="product-rate d-inline-block">
                      {rate.value === 1 && <div className="product-rating" style={{ width: "20%" }}></div>}
                      {rate.value === 2 && <div className="product-rating" style={{ width: "40%" }}></div>}
                      {rate.value === 3 && <div className="product-rating" style={{ width: "60%" }}></div>}
                      {rate.value === 4 && <div className="product-rating" style={{ width: "80%" }}></div>}
                      {rate.value === 5 && <div className="product-rating" style={{ width: "100%" }}></div>}
                    </div>
                  </div>
                </>
              )}
