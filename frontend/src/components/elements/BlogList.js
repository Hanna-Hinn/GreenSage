                ...
                <article className="wow fadeIn animated hover-up mb-30" key={i}>
                    ...
                    >
                        <div className="entry-meta">
                            <Link to="/blog-category-grid" className="entry-meta meta-2">
                                Technology
                            </Link>
                        </div>
                    </div>
                    <div className="entry-content-2">
                        <h3 className="post-title mb-15">
                            <Link to="/blog-post-right">Ettitude — Beautifully Designed Bamboo Sheets & Sleep Wear-Home Décor Holiday Gift Guide</Link>
                        </h3>
                        ...
                        <div className="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                            ...
                            <Link to="/blog-post-right" className="text-brand">
